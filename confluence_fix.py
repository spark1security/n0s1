# coding=utf-8
# /Users/user/PycharmProjects/n0s1/.venv/lib/python3.13/site-packages/atlassian/confluence/__init__.py
import io
import json
import logging
import os
...
class Confluence(AtlassianRestAPI):
    ...
    def enhanced_cql(
        ...
        :param next (Optional[str]): Token for paginated results. Default: None.
        ...
        if not self.cloud:
            raise ValueError("``enhanced_cql`` method is only available for Confluence Cloud platform")
        params: dict = {}
